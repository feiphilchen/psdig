...
uprobe_cmd='psdig trace uprobe uprobe_c/test_uprobe uprobed_add1 uprobed_add2  uprobed_add3 uprobed_add4 uprobed_add5 uprobed_add6'
uprobe_cmd2='psdig trace uprobe uprobe_c/test_uprobe xxx'
...
def test_uprobe_c_prog(test_cmd, probe_cmd, filter_str, output_fmt, expect_traces, expect_error):
